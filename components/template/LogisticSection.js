import { Box, Container, Flex, Heading, Text, Button, Image, SimpleGrid, Link } from "@chakra-ui/react";
import styles from '../../styles/LogisticSection.module.css'
import custImg from '../../assets/userimg.png'
        ...
        <Flex wrap="wrap">
          ...
          <Box width={['100%', '50%']}>
            ...
            <Flex mt="8" align='center' justify='center'wrap="wrap">
              <Box width={['100%', '50%']}>
                <Button variant="outline" colorScheme="red" size="lg" fontWeight="bold">Pricing & Plans</Button>
              </Box>
