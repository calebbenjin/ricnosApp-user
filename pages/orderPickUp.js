...
export default function OrderPickUpPage() {
  ...
  return (
    <Layout>
      <Box className={login.pickupOrder}>
        <Box className={login.pickupForm}>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Flex justify=''>
                  <Stack spacing={5} direction={['column', 'row']} my='6'>
                    <Checkbox colorScheme='red'>Insurance</Checkbox>
                    <Checkbox colorScheme='red'>Packaging</Checkbox>
                  </Stack>
                  <Stack spacing={5} direction={['column', 'row']} my='6'>
                ...
                <Box textAlign='left' mb='20' mt='10'>
                  <button type='submit' className={login.addBtn}>
                    Add more Items
                  </button>
                </Box>
